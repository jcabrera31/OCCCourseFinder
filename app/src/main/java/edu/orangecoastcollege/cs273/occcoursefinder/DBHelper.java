...
class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String INSTRUCTORS_KEY_FIELD_ID = "id";
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        // By creating the FOREIGN KEY so we make sure that we don't offer any courses that doesn't exist.
    ...
    public void updateOffering(Offering offering) {
        ...
        values.put(OFFERINGS_KEY_FIELD_ID, offering.getCRN());
